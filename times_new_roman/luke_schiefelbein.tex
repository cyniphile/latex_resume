...
\employer{Granarolo S.p.A}{Bologna, Italy}{Data Scientist, \euro 1B+ Food Products Company}{February-May 2021}
\begin{achievements}
    \item Created new data science position in coordination with the CEO and CFO. Worked mainly in Italian.
    \item Built a statistical analysis (presented to the Board and CEO) to decide the fate of a major relaunch of the highest revenue product line.
\end{achievements}

\employer{Freelance Screenwriter}{September 2019 - February 2021}{}{}
\vspace*{-10pt}
\begin{achievements}
